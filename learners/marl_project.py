...
device = "cuda"
#Questions
#1. where does the reward get accessed here?
#   A: line 147
#2. how is the intrinsic reward calculated in liir?
#   A: r_in is a function which takes an individual state-action pair as input
#   A: this is done as part of the critic in an actor-critic architecture
#3. what is the structure of maven?
#   A: purely q-network based
#3. where do you add stuff to the buffer?


# structure: basically a maven q learner with a LIIR critic to provide r_in
#Q: How to train the LIIR critic? -> How do they train the critic in LIIR?
# -> will simple backprop work?? I think so right?
class QLearner:
